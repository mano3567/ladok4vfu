databaseChangeLog = {
    changeSet(author: "mano3567", id: "202210201210") {
        createTable(tableName: "l3undervisnings_form") {
            column(autoIncrement: "true", name: "id", type: "bigint") {
                constraints(nullable: "false", primaryKey: "true", primaryKeyName: "undervisningsFormPK")
            }
        ...
        addUniqueConstraint(columnNames: "edu, ladok_id", constraintName: "UKEduLIDL3UtForm", tableName: "l3undervisnings_form")
    }
}
